...
bool AndreSeznecTAGECookbook::get_prediction(uint64_t pc) {
  return impl->GetPrediction(pc);
}

void AndreSeznecTAGECookbook::update_predictor(uint64_t pc, branch_type type,
...
void AndreSeznecTAGECookbook::track_other_inst(uint64_t pc, branch_type type,
                                               bool branch_taken,
                                               uint64_t branch_target) {
