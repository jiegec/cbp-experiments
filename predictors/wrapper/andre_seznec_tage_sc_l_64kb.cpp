...
bool AndreSeznecTAGESCL64KB::get_prediction(uint64_t pc) {
  return impl->GetPrediction(pc);
}

void AndreSeznecTAGESCL64KB::update_predictor(uint64_t pc, branch_type type,
...
void AndreSeznecTAGESCL64KB::track_other_inst(uint64_t pc, branch_type type,
                                             bool branch_taken,
                                             uint64_t branch_target) {
