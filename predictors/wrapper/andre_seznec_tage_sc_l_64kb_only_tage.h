...
class AndreSeznecTAGESCL64KBOnlyTAGE : public ConditionalBranchPredictor {
public:
  AndreSeznecTAGESCL64KBOnlyTAGE();
...
private:
  andre_seznec_tage_sc_l_64kb_only_tage::PREDICTOR *impl;
};